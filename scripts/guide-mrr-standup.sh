...
echo "| Paying | Count Pro/Elite; first checkout goal ≥ 1 |"
echo "| checkout_clicks_7d | Should move after /ops/billing test |"
echo "| plan_intents_7d | From ?plan=pro|elite signups |"
echo "| deploy_success_7d | Activated users ready to upgrade |"
