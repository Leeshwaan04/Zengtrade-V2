...
Organic UTMs to track in `/admin`: `home_coins`, `pricing_coins`, `pricing_pro`, `pricing_elite`, `signup_coins`, `signup_nudge_coins`, `deploy_success_coins`, `paper_loop_coins`.
