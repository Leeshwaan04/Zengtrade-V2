...
| `utm_campaign` | `landing`, `pricing`, `pricing_pro`, `pricing_elite`, `home_coins`, `pricing_coins`, `signup_coins`, `signup_nudge_coins`, `deploy_success_coins`, `paper_loop`, `paper_loop_coins`, `build_in_public`, `build_in_public_coins`, `weekly_proof`, `weekly_proof_partial`, `coin_spotlight_{slug}`, `algotrading_draft` |
